...
2. [Setup - The basics of getting started with ecmf](#setup)
    * [What ecmf affects](#what-ecmf-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with ecmf](#beginning-with-ecmf)
