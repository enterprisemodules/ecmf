shared_examples "a nagios installer" do | settings|
  ...
  before do
    hiera_values_on_sut({
      ...
      'ecmf::roles::monitoring::implementation' => 'ecmf::profile::monitoring::nagios'
    })
  end
  ...
  it 'installs the nagios software' do
    apply_manifest(manifest, :expect_changes => true)
  end

  #
  # The monitoring directory should be made
  #
